...
class SmtpServerTest < ActiveSupport::TestCase
  before do
    @server = SmtpServer.new host: 'smtp.gmail.com', port: 587,
        domain: 'gmail.com', user_name: 'igor_test@gmail.com',
        password: 'pa55w0rd', from: '"Igor Dev Staff" <igor_test@gmail.com>',
  ...
  describe '#action_mailer_options' do
    it 'works for plain authentication' do
      golden = {
        ...
        user_name: 'igor_test@gmail.com', password: 'pa55w0rd',
