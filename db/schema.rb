...
ActiveRecord::Schema.define(version: 20110704070001) do
  ...
  create_table "analyzers", force: :cascade do |t|
    ...
    t.boolean  "auto_grading",   limit: 1,     default: false, null: false
  ...
  create_table "announcements", force: :cascade do |t|
    ...
    t.boolean  "open_to_visitors", limit: 1,    default: false, null: false
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "assignments", force: :cascade do |t|
    ...
    t.string   "name",               limit: 64,                                          null: false
    t.boolean  "deliverables_ready", limit: 1,                           default: false, null: false
    t.boolean  "metrics_ready",      limit: 1,                           default: false, null: false
    t.boolean  "accepts_feedback",   limit: 1,                           default: false, null: false
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "courses", force: :cascade do |t|
    ...
    t.boolean  "email_on_role_requests", limit: 1,                null: false
    t.boolean  "has_recitations",        limit: 1,                null: false
    t.boolean  "has_surveys",            limit: 1,                null: false
    t.boolean  "has_teams",              limit: 1,                null: false
  ...
  create_table "prerequisite_answers", force: :cascade do |t|
    ...
    t.boolean  "took_course",     limit: 1,     null: false
  ...
  create_table "registrations", force: :cascade do |t|
    t.integer  "user_id",               limit: 4,                 null: false
    t.integer  "course_id",             limit: 4,                 null: false
    t.boolean  "dropped",               limit: 1, default: false, null: false
    t.boolean  "for_credit",            limit: 1, default: true,  null: false
    t.boolean  "allows_publishing",     limit: 1, default: true,  null: false
  ...
  create_table "survey_questions", force: :cascade do |t|
    ...
    t.boolean  "scaled",          limit: 1,    default: false,   null: false
    t.boolean  "targets_user",    limit: 1,    default: false,   null: false
    t.boolean  "allows_comments", limit: 1,    default: false,   null: false
  ...
  create_table "team_partitions", force: :cascade do |t|
    ...
    t.boolean  "automated",  limit: 1,  default: true,  null: false
    t.boolean  "editable",   limit: 1,  default: true,  null: false
